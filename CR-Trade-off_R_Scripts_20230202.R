...
#jinnyang@umich.edu
source("I-C_Rcode_Functions.R")

######### Part 1: Calculate net growth rate for each ASV########
library("gdata")
library("phyloseq")
library(ggpubr)
library(stats)
...
######### Part 2: Calculate regression slope (resistance) and intercept (top-down control-free growth) ####
  ...
  #### 2. Figure 2: Plot Competitiveness-Invulnerability trade-off ####
  ...
  #### Figure S6: Viral-caused mortality (SlopeD30-Slope_D02) ~ Predation-free growth rate (IGR) ####
...
######### Part 3: Preparing diversity index  ####
  #### 1. Richness and Rank-based normalization #### 
...
########### Part 4: LMM analysis ################################################
  ...
  #### 1. Resistance ~ competition ####
  
  
  #### 2. Diversity ~ Top-down control dilution factors #### 
...
########### Part 5: Figure 3:Plot top-down control effect on diversity ################################################  
  ############## Plot diversity ######
  ...
  #### A. Figure 3: Plot predation ~ RAD decay coefficient, evenness, or richness relationships ####
